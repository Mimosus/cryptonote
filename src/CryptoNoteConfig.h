...
const uint64_t MONEY_SUPPLY                                  = 150000000 ;
const unsigned EMISSION_SPEED_FACTOR                         = 18;
static_assert(EMISSION_SPEED_FACTOR <= 24 * sizeof(uint64_t), "Bad EMISSION_SPEED_FACTOR");
...
const char     CRYPTONOTE_NAME[]                             = "PrivaCom";
